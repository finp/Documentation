...
include::_partials/con_knative-OCP-311.adoc[leveloffset=+1]

// Installing Knative on an OpenShift 3.11 cluster using the script provided
include::_partials/proc_installing-knative-OCP-311.adoc[leveloffset=+1] 

// Allowing external access to Knative services using a configured hostname (post-installation tasks)
include::_partials/proc_allowing-external-access-knative-services-OCP-311.adoc[leveloffset=+1] 
